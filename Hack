(async () => {
    ...
    let p, u, h, m, $, g, y, b, v, _ = l("div", {
        ...
        target: "_blank",
        href: "https://github.com/PrimateTerrorVR/NEW-Blooket-OP-Menu",
